...
const skills = [
  ...
  { name: "AWS (EC2/S3)", level: 70, category: "cloud" },
  ...
  { name: "Multithreading", level: 75, category: "systems" },
  { name: "Socket Programming", level: 70, category: "systems" },
  ...
  { name: "TensorFlow", level: 60, category: "data" },
];
